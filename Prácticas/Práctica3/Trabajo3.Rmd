...
Vamos a crear la variable mpg01. Tenemos que definirla como un factor, usando la función *as.factor*. Para poder hacer el aprendizaje de modo correcto, la mediana la realizaremos sólo con los datos de entrenamiento, y dicha mediana la usaremos para ambos conjuntos.
