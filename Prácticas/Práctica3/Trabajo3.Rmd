...
Podemos ver, los valores que tienen menos error son 5 y 7. No tenemos más información, luego no podemos decidirnos entre los dos. Para poder realizar el siguiente apartado, vamos a guardar la predicción obtenida usando como *k* el valor 5.
...
```{r}
#Por lo que he leido, Rand.forest es un caso particular de
#Bagging, como no encuentro un método que lo haga, voy a 
#hacer rand.Forest, y luego si no, lo uso para b)
library(randomForest)
a.forest = randomForest(medv~crim+zn+indus+chas+nox+rm+age+dis+rad+tax+ptratio+black+lstat, data = Boston.train)
pred = predict(a.forest,Boston.test)
