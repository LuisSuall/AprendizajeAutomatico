...
for(i in 1:5){
  ...
  #Clasificacion K-NN
  prediccion.knn = knn(Auto.train.knn[,c("displacement","horsepower","weight")],Auto.test.knn[,c("displacement","horsepower","weight")], Auto.train.knn[,"mpg01"],k = 5)
...
Obtenemos un error de 0.80. Podemos ver que el mayor número de fallos se producen al clasificar elementos que son *CH* como *MM*. Antes hemos elegido un punto de corte aleatoriamente. Si quisieramos conseguir mejorar esto, podríamos ser más restrictivos al seleccionar algo como *CH*, subiendo ese punto de corte. Este tipo de estudio es el que podemos observar en la curva ROC.
